...
public class AccountServiceImpl implements AccountService {
	 ...
	 * 
	 * @see com.safe.stack.service.AccountService#authenticate(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.safe.stack.service.AccountService#signUpAUser(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	public void signUpAUser(String userName, String password) {
		...
		entityManager.flush();
		entityManager.clear();
		authenticate(acc.getEmail(), acc.getPassword());
