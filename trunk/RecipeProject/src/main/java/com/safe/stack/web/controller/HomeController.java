...
public class HomeController {
	...
	private static final String RECIPE_LIST_PAGE = "recipe/list";
	private static final String RECIPE_LOGIN_PAGE = "recipe/login";
	...
	public String searchRecipes(@RequestParam("ingredient") String ingredient,
			Model uiModel) {
